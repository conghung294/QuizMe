...
import { ChevronLeft, ChevronRight, CheckCircle, XCircle, Home, RotateCcw, Trophy, Target, Clock } from 'lucide-react'
...
export default function PracticePage() {
    ...
    const checkAnswer = () => {
        if (!selectedAnswer) {
            toast.warning("Vui lòng chọn một đáp án trước khi kiểm tra")
            return
        }
        ...
        if (selectedAnswer === currentQuestion.correctAnswer) {
            ...
            toast.error(`Chưa chính xác. Đáp án đúng là: ${currentQuestion.correctAnswer}`)
        }
    }
    ...
    const isCompleted = Object.keys(userAnswers).length === questions.length
    const accuracy = isCompleted ? ((score / questions.length) * 100).toFixed(1) : '0'
                    ...
                    <CardHeader className="pb-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-2">
                                ...
                                {showAnswer && (
                                    <Badge className={selectedAnswer === currentQuestion.correctAnswer ? 'bg-green-100 text-green-800 border-green-200' : 'bg-red-100 text-red-800 border-red-200'}>
                            ...
                            {!showAnswer ? (
                                ...
                                <div className="text-center">
                                    <Badge variant="secondary" className="px-6 py-3 text-base">
                                        {selectedAnswer === currentQuestion.correctAnswer ? '🎉 Chính xác!' : '💪 Cố gắng lần sau!'}
                                    </Badge>
                                </div>
                            )}
